...
<fieldset>
        ...
        <form action="index.php" method="post">
            ...
            <p>Nota examen final: <input type="text" name="txtN4"></p>
            <p>Nota trabajo final: <input type="text" name="txtN5"></p>
    ...
    <?php
        if($_POST){
            ...
            if($n1<0||$n1>100){
                ...
                echo "el promedio es: ".$promfin."<br>";
                if ($promfin>=61){
                    echo "el estudiante $nombre paso la materia con $promfin";
                }else{
                    echo "el estudiante $nombre perdio la materia con $promfin";
                }
            }
        }
    ?>
